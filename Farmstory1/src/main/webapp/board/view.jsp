			...
			$.ajax({
				...
				success: function(data){
					...
					if(data.result > 0) {
						...
						article += "<div>";
						article += "<a href='#' class='del' data-no='"+data.no+"' data-parent=''"+data.parent+">삭제</a>";							
...
<main id="board">
    <section class="view">
        <table border="0">
            ...
            <tr>
                <th>첨부파일</th>
                <td><a href="./proc/download.jsp?parent=<%= article.getNo() %>"><%= article.getOriName() %></a>&nbsp;<span><%= article.getDownload() %></span>회 다운로드</td>
            </tr>
            <% } %>
            <tr>
                <th>내용</th>
        ...
        <div>
            ...
            <% } %>
            <a href="./list.jsp?group=<%= group %>&cate=<%= cate %>&no=<%= article.getNo() %>&pg=<%= pg %>" class="btn btnList">목록</a>
        </div>
        ...
        <section class="commentList">
            ...
            <article>
                ...
                <div>
                    <a href="#" class="del" data-no="<%= comment.getNo() %>" data-parent="<%= comment.getParent() %>">삭제</a>
